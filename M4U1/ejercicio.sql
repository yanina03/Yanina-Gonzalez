...
-- Tiempo de generación: 17-02-2023 a las 20:11:04
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  `trabajo` varchar(70) COLLATE utf8mb4_general_ci NOT NULL,
  `edad` int NOT NULL,
  `salario` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
